...
<script type="text/javascript">
	...
	{
		$.post("fetch_hfiber_LcoName.php", {search_acc_no:value}, function(data)
		{
...
#note
{
	...
	<?php
		...
		if ($_SERVER['REQUEST_METHOD']=='POST')
		{
			...
			{
				$query="INSERT INTO hfiber_customerbase(base_account_no, base_name, base_contact_no, base_address, base_pin_code, base_switch, base_lco_code, base_lco_name) VALUES('$account','$name','$con_no','$address','$pin','$switch','$lcocode','$lconame')";
	...
	<form role="from" class="form-horizontal" action="" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="hfiber_cust_account_no" id="hfiber_cust_account_no" placeholder="Customer Account No." value="" autocomplete="off"  maxlength="10" required>
			<div class="input-group-addon"><span class="glyphicon glyphicon-star"></span></div>
			</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="input-group">
			<div class="input-group-addon"><span class="glyphicon glyphicon-th-large"></span></div>
			<input type="text" class="form-control" name="hfiber_lco_code" id="hfiber_lco_code" placeholder="LCO Code" autocomplete="off" value="" oninput="getlcoName(this.value)" required>
			<div class="input-group-addon"><span class="glyphicon glyphicon-star"></span></div>
			</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="input-group">
			<div class="input-group-addon"><span class="glyphicon glyphicon-th-large"></span></div>
			<input type="text" class="form-control" name="hfiber_cust_name" id="hfiber_cust_name" placeholder="" autocomplete="off" required>
			<div class="input-group-addon"><span class="glyphicon glyphicon-star"></span></div>
			</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="input-group">
			<div class="input-group-addon"><span class="glyphicon glyphicon-user"></span></div>
			<input type="text" class="form-control" id="hfiber_lco_name" name="hfiber_lco_name" placeholder="" autocomplete="off" value=" " required>
			<div class="input-group-addon"><span class="glyphicon glyphicon-star"></span></div>
			</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="hfiber_cust_contact_no" name="hfiber_cust_contact_no" placeholder="" autocomplete="off" maxlength="10" required>
			<div class="input-group-addon"><span class="glyphicon glyphicon-star"></span></div>
			</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="input-group">
			<div class="input-group-addon"><span class="glyphicon glyphicon-th-large"></span></div>
			<input type="text" class="form-control" id="hfiber_cust_switch" name="hfiber_cust_switch" placeholder="  " autocomplete="off" value="" required>
			<div class="input-group-addon"><span class="glyphicon glyphicon-star"></span></div>
			</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="hfiber_cust_address" name="hfiber_cust_address" placeholder="  " autocomplete="off" value="" required>
			<div class="input-group-addon"><span class="glyphicon glyphicon-star"></span></div>
			</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="input-group">
			<div class="input-group-addon"><span class="glyphicon glyphicon-refresh"></span></div>
			<input type="text" class="form-control" id="hfiber_cust_pin_code" name="hfiber_cust_pin_code" placeholder="  " autocomplete="off" value="" required>
			<div class="input-group-addon"><span class="glyphicon glyphicon-star"></span></div>
			</div>
			</div>
