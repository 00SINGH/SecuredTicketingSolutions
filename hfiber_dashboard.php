<?php include "inc/header.php"; ?>
	...
	<hr>
	 ...
	 <?php
					...
					{ */
						$query="SELECT COUNT(hfiber_ttid) FROM cust_hfiber_workorder  WHERE hfiber_cust_status!='RESOLVED' AND hfiber_cust_team='Field Support'";
					/*}
					elseif(custSession::get('user_role')=='CS')
					{
						//$query="SELECT COUNT(hfiber_ttid) FROM cust_hfiber_workorder  WHERE hfiber_cust_status!='RESOLVED' AND hfiber_cust_team!='Field Support' AND hfiber_cust_team!='Optical Team'";
					}
					elseif(custSession::get('user_role')=='RF')
					{
						$query="SELECT COUNT(hfiber_ttid) FROM cust_hfiber_workorder  WHERE hfiber_cust_status!='RESOLVED' AND hfiber_cust_team='Optical Team'";
					}*/
                    ...
                    if(custSession::get('user_role')=='FS')
					{
						$query=("SELECT * FROM cust_hfiber_workorder WHERE hfiber_cust_status!='RESOLVED' AND hfiber_cust_team='Field Support' ORDER BY hfiber_ttid DESC LIMIT $start, $per_page");
					}
					elseif(custSession::get('user_role')=='CS')
					{
						$query=("SELECT * FROM cust_hfiber_workorder WHERE hfiber_cust_status!='RESOLVED' ORDER BY hfiber_ttid DESC LIMIT $start, $per_page");
					}
					elseif(custSession::get('user_role')=='RF')
					{
						$query=("SELECT * FROM cust_hfiber_workorder WHERE hfiber_cust_status!='RESOLVED' AND hfiber_cust_team='Optical Team' ORDER BY hfiber_ttid DESC LIMIT $start, $per_page");
					}
					elseif(custSession::get('user_role')=='ADMIN')
					{
						$query=("SELECT * FROM cust_hfiber_workorder WHERE hfiber_cust_status!='RESOLVED' ORDER BY hfiber_ttid DESC LIMIT $start, $per_page");
					}					
                    $result=$db->select($query);
	...
	<div class="table-responsive">
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td><a href="details_hfiber_workorder.php?view=<?php echo $value['hfiber_ttid']; ?>">View </a> 
				|| <a href="edit_hfiber_workorder.php?update=<?php echo $value['hfiber_ttid']; ?>">Edit </a>
