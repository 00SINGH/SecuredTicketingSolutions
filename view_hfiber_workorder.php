<?php include "inc/header.php"; ?>
	...
	<hr>
	 ...
	 <?php 
                    ...
                    $query="SELECT COUNT(hfiber_id) FROM cust_hfiber_workorder  WHERE hfiber_cust_status='In-Progress'";
                    ...
                    $query=("SELECT * FROM cust_hfiber_workorder WHERE hfiber_cust_status='In-Progress' ORDER BY hfiber_id DESC LIMIT $start, $per_page");
                    $result=$db->select($query);
                    $i=1;
	...
	<div class="table-responsive">
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td><a href="details_hfiber_workorder.php?view=<?php echo $value['hfiber_id']; ?>">View</a> 

                <?php if (custSession::get('user_name')==$value['hfiber_creator'] || custSession::get('user_role')=='Co-Ordinator') {?>


                || <a href="edit_hfiber_workorder.php?update=<?php echo $value['hfiber_id']; ?>">Edit</a> 
